...
# ID number of GPUMODEL.FREQUENCY_KEEP
...
_C.DATALOADER.NUM_INSTANCE = 4 # You can adjust it to 8 to save memory while the batch_size need to be 64 to ensure the number of ID
...
_C.SOLVER.MAX_EPOCHS = 350 #120
# Base learning rate
_C.SOLVER.BASE_LR = 0.008  #0.009
...
_C.SOLVER.CENTER_LOSS_WEIGHT = 0.0005 #0.0005
# Settings of range loss
_C.SOLVER.RANGE_K = 2
_C.SOLVER.RANGE_MARGIN = 0.3
_C.SOLVER.RANGE_ALPHA = 0
_C.SOLVER.RANGE_BETA = 1
_C.SOLVER.RANGE_LOSS_WEIGHT = 0.9#1
# Settings of weight decay
_C.SOLVER.WEIGHT_DECAY = 0.0001#0.00001
_C.SOLVER.WEIGHT_DECAY_BIAS = 0.00001
# decay rate of learning rate
_C.SOLVER.GAMMA = 0.1
# decay step of learning rate
_C.SOLVER.STEPS = (80, 150)#(40, 70)
# warm up factor
_C.SOLVER.WARMUP_FACTOR = 0.1#0.01
# iterations of warm up
_C.SOLVER.WARMUP_ITERS = 10#10
...
_C.SOLVER.IMS_PER_BATCH = 64#128 # You can adjust it to 64
